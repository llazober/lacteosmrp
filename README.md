...
*   **[`manual_sistema.md`](file:///c:/Users/luisl/LacteosMrp/manual_sistema.md)**: Manual operativo y guía de usuario detallada por cada módulo funcional.
...
> El sistema incluye un Asistente de IA en tiempo real para apoyar a los operarios. Este asistente lee **dinámicamente** el archivo [`manual_sistema.md`](file:///c:/Users/luisl/LacteosMrp/manual_sistema.md) desde el disco para resolver dudas sobre los procesos de la empresa.
> 
> **Cada vez que agregues, elimines o cambies una funcionalidad o módulo en el sistema:**
> 1. Actualiza la sección correspondiente dentro de [`manual_sistema.md`](file:///c:/Users/luisl/LacteosMrp/manual_sistema.md) describiendo el nuevo flujo operativo en español claro.
