  ...
  const rolesDefault = [
    {
      ...
      permisos: JSON.stringify([
        ...
        'VER_COMPRAS', 'GESTIONAR_COMPRAS', 'VER_REQUERIMIENTOS_MP', 'GESTIONAR_REQUERIMIENTOS_MP', 'VER_FINANZAS', 'GESTIONAR_FINANZAS',
        ...
        'VER_PICKING', 'CONFIRMAR_PICKING', 'VER_RECEPCIONES', 'GESTIONAR_RECEPCIONES'
      ])
    },
    {
      nombre: 'SUPERVISOR',
    ...
    },
    {
      ...
      permisos: JSON.stringify([
        'VER_DASHBOARD', 'VER_POS', 'REALIZAR_VENTAS', 'VER_VENTAS', 'VER_FRIO',
        'VER_TRAZABILIDAD', 'VER_INVENTARIO', 'GESTIONAR_INVENTARIO',
        'VER_COMPRAS', 'VER_REQUERIMIENTOS_MP', 'VER_CHAT', 'USAR_ASISTENTE', 'VER_UTILIDADES',
        'VER_PRODUCTOS', 'VER_LOTES', 'VER_RECEPCIONES'
      ])
    },
    {
      nombre: 'CAJERO',
    ...
    },
    {
      ...
      permisos: JSON.stringify([
        ...
        'VER_RUTA_OPERACIONES', 'GESTIONAR_RUTA_OPERACIONES',
        'VER_COMPRAS',
        'GESTIONAR_COMPRAS', 'VER_REQUERIMIENTOS_MP', 'GESTIONAR_REQUERIMIENTOS_MP', 'VER_CHAT', 'VER_UTILIDADES',
        'VER_PICKING', 'CONFIRMAR_PICKING', 'VER_RECEPCIONES', 'GESTIONAR_RECEPCIONES'
      ])
    },
    {
      ...
      permisos: JSON.stringify([
        'VER_DASHBOARD', 'VER_CALIDAD', 'GESTIONAR_CALIDAD', 'VER_LOTES', 'VER_CHAT', 'VER_RECEPCIONES'
      ])
    }
  ];
