...
- En tu respuesta durante el tour, usa este formato:
  ...
  private ejecutarTour(accion: string, indiceActual: number): any {
    const TOUR_SECUENCIA = [
      ...
      { nombre: 'Planificación de Producción', emoji: '📋', seccion: 'planificacion_produccion', path: '/produccion/planificacion' },
      { nombre: 'Ruta de Operaciones', emoji: '⚙️', seccion: 'ruta_operaciones', path: '/produccion/operaciones' },
  ...
  private async ejecutarNavegacion(user: any, seccion: string) {
    const PAGE_PERMISSIONS: Record<string, { permission: string; path: string }> = {
      ...
      planificacion_produccion: { permission: 'VER_PLANIFICACION_PRODUCCION', path: '/produccion/planificacion' },
      ruta_operaciones: { permission: 'VER_RUTA_OPERACIONES', path: '/produccion/operaciones' },
    ...
    const ALIASES: Record<string, string> = {
      ...
      'planificacion de produccion': 'planificacion_produccion',
      'planificacion produccion': 'planificacion_produccion',
      'planificacion_produccion': 'planificacion_produccion',
      'ruta de operaciones': 'ruta_operaciones',
      'ruta operaciones': 'ruta_operaciones',
      'ruta_operaciones': 'ruta_operaciones',
      'operaciones': 'ruta_operaciones',
      'kanban de produccion': 'ruta_operaciones',
      'kanban': 'ruta_operaciones',
