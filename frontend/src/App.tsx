    ...
    <Box sx={{ display: 'flex', flexDirection: { xs: 'column', md: 'row' }, height: '100vh', width: '100vw', overflow: 'hidden' }}>
      ...
      <Box component="main" sx={{ flexGrow: 1, height: { xs: 'calc(100vh - 56px)', md: '100vh' }, overflowX: 'auto', overflowY: 'hidden', backgroundColor: '#0b0f19', position: 'relative' }}>
        ...
        <Routes>
          ...
          <Route path="/bodegas/leche-entera" element={<BodegaLecheEntera tipo="LECHE_ENTERA" />} />
          <Route path="/bodegas/leche-descremada" element={<BodegaLecheEntera tipo="LECHE_DESCREMADA" />} />
          <Route
            path="/produccion"
            element={
          ...
          {usuario?.permisos?.includes('VER_REQUERIMIENTOS_MP') || usuario?.rol === 'ADMINISTRADOR' || usuario?.rol === 'SUPERVISOR' ? (
            ...
            <Route path="/compras/requerimientos" element={<Navigate to="/" />} />
          )}
